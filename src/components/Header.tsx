  ...
  return (
    <header className="hidden sm:flex bg-studio-lavender border-b border-purple-100 px-6 py-4 items-center justify-end md:justify-between">
      <Link to="/" className="hidden md:block">
        <img src="/logo.png" alt="The Next Step Dance Studio" className="h-14 w-auto border-0" width="620" height="314" />
      </Link>
      <div className="flex flex-col items-end gap-0.5 text-right">
        ...
        <span className="text-xs text-gray-600">Birdsboro, PA</span>
        <a
          href="mailto:missy@thenextstepdance.com"
          className="text-xs text-studio-purple hover:underline"
        >
